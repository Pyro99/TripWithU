...
app.get("/hotels/sort/pricing",(req,res) => {
  ...
  if(pricing === "low-to-high"){
    hotelsCopy.sort(sortHotelsByPriceLowToHigh);
    res.json({hotels:hotelsCopy});
  } else if(pricing === "high-to-low") {
    hotelsCopy.sort(sortHotelsByPriceHighToLow);
    res.json({hotels:hotelsCopy});
  }
  res.json({hotels:hotelsCopy});
...
app.get("/hotels/sort/rating",(req,res) => {
  ...
  if(rating === "low-to-high"){
    hotelsCopy.sort(sortHotelsByRatingLowToHigh);
    res.json({hotels:hotelsCopy});
  } else if(rating === "high-to-low") {
    hotelsCopy.sort(sortHotelsByRatingHighToLow);
    res.json({hotels:hotelsCopy});
  }
  res.json({hotels:hotelsCopy});
...
function sortHotelsByReviewsMotToLeast(hotel1, hotel2){
...
app.get("/hotels/sort/reviews",(req,res) => {
  ...
  if(reviews === "least-to-most"){
    ...
    hotelsCopy.sort(sortHotelsByReviewsMotToLeast);
    res.json({hotels:hotelsCopy});
  }
  res.json({hotels:hotelsCopy});
